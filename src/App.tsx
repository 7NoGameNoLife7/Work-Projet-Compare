...
function App() {
  ...
  return (
    <>
      <ComparisonArea selectedRecipes1 =  {selectedRecipes1}  selectedRecipes2 = {selectedRecipes2}/>
      <RecipeList  recipes = {recipes}  setSelectedRecipes1 = {setSelectedRecipes1} setSelectedRecipes2 = {setSelectedRecipes2} />  
